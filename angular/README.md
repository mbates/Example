Mobile Application based on [AngularJS](http://angularjs.org) and [ngbp](http://joshdmiller.github.com/ng-boilerplate)
...
# if you get errors at bower install
$ bower cache clean
```

Finally, open `file:///path/to/angular/www/index.html` in your browser.


## NGBP

`ngbp` is designed to make life easy by providing a basic framework
